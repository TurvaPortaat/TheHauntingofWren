...
public class CameraManager : MonoBehaviour
{
    ...
    public float cameraCollisionOffSet = 0.2f;  //How much the camera will jump off of objects its collidng with
    ...
    private void HandleCameraCollisions()
    {
        ...
        RaycastHit hit; //This variable tells us what we hit
